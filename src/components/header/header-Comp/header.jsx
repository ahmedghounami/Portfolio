...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        "relative flex min-h-[45rem] scroll -pb-36 flex-col items-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}>
      <div
        className="relative flex flex-1  items-center justify-center isolate z-0 ">
        <motion.div
        ...
        <div
          className="absolute top-1/2 h-48 w-full scale-x-150 bg-slate-950 blur-2xl"></div>
        <div
          className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
        <div
          className=" absolute inset-auto z-50 w-[28rem]rounded-full bg-cyan-500 opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
